...
const SideBar: FunctionComponent<ISideBarProps> = (props) => {
  ...
  return (
    <div className="drawer-container absolute top-0 left-0 z-10 ">
      ...
      ></label>
      <div className="py-4 drawer-content absolute top-0 left-0  w-[290px] h-screen overflow-y-auto drawer-content ml-[-290px]  w-80 bg-lightCompBg dark:bg-darkCompBg">
        <div className="flex flex-col gap-2 items-center  px-6">
          <h2 className="text-secondary dark:text-white ">Khaled Sobhy</h2>
          ...
          <div className="border-t w-full my-3 dark:border-gray-500"></div>
          {/* my info */}
          ...
          <a
            ...
            download={true}
            target="_blank"
            className="gap-2 text-sm px-4 py-2 uppercase bg-primary dark:text-white text-black text-nowrap flex justify-center items-center"
          >
